...
/**
 * @Author: Gian
 * @Date:   2018-12-13 15:41:42
 * @Last Modified by:   Gian
 * @Last Modified time: 2018-12-13 15:45:49
 */
?>
<div class="container">
			    <div class="row">
			      	<div class="col-md-4 pr-0">
			        	<div class="admission-leftpane bg-white" style="border:1px solid #CCC;">
			      			...
			      			<ul>
			        			<li class=" active ptb-5"><a href="<?= base_url()?>index.php/admin/reports/summary">Summary</a><i class="fa fa-play"></i></li>
					            <li class=""><a href="<?= base_url()?>index.php/admin/reports/detail">Detail</a><i class="fa fa-play"></i></li>
			      			</ul>
			        	</div>
			    	</div>
			    	<div class="col-md-20">
									...
									<div class="row">
										<div class="col-md-24">
											<div class="row">
												...
												<div class="col-md-8">
													<div class="form-group">
													    <label for="initialCode" class="label-font-arial">Office</label>
													    <input type="text" class="form-control inp-nbr" id="initialCode">
													</div>
												</div>
											</div>
											<div class="row">
